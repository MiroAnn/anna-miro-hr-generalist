const experience = [
  ...
  },
  {
    ...
    role: "Рекрутер",
    period: "2026",
    text: <>Закрыла четыре вакансии <a href="https://goo.gl/maps/tbHczGBejHC2" target="_blank" rel="noreferrer">для вилл Masbro на Бали</a> по своему методу быстрого найма.</>,
  ...
  },
  {
    ...
    role: "Рекрутер",
    period: "2025",
    text: <>Для стартапа <a href="https://rejoin.app/" target="_blank" rel="noreferrer">RE:join</a> закрыла ключевые позиции для быстрого роста.</>,
  ...
  },
  {
    ...
    text: "Помогла 100+ командам ускориться на пути к деньгам, а также развивала сотрудников компаний для того, чтобы они выдерживали нагрузку, конфликты и без потерь проходили через кризисные времена. Также помогала с наймом и процессами.",
    hire: "Выстраивала процессы найма и развивала сотрудников",
    tone: "mint",
  },
];
